...
const (
	...
	Auth_SetRole_FullMethodName  = "/auth.Auth/SetRole"
)
...
type AuthClient interface {
	...
	SetRole(ctx context.Context, in *RoleRequest, opts ...grpc.CallOption) (*RoleResponse, error)
}
...
func (c *authClient) SetRole(ctx context.Context, in *RoleRequest, opts ...grpc.CallOption) (*RoleResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type AuthServer interface {
	...
	// Добавление пользователю роли
	SetRole(context.Context, *RoleRequest) (*RoleResponse, error)
...
func (UnimplementedAuthServer) SetRole(context.Context, *RoleRequest) (*RoleResponse, error) {
...
func _Auth_SetRole_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServer).SetRole(ctx, req.(*RoleRequest))
	}
	return interceptor(ctx, in, info, handler)
}
